package com.example.carmax.Registration;
...
import com.example.carmax.Model.MechanicModel;
import com.example.carmax.R;
import com.example.carmax.viewScreen.Profile;
...
public class Mechanic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Post  for Sale");

//        Drop down list of mechanics
        String [] specification = new String[] {"Luxury Vehicles", "Sports and Performance", "SUV and Off-roads", "Buses and Mini-Vans ",
        "Lorries And Trailers", "Heavy Duty ", "General"};
...
//        Toast.makeText(this, "Start okello....", Toast.LENGTH_LONG).show();
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(Mechanic.this, "Fail...", Toast.LENGTH_SHORT).show();
            ...
            public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Mechanic.this, "Success...", Toast.LENGTH_LONG).show();
